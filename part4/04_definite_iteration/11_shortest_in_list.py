...
one are equally short, the function can return any of
the shortest strings (there will be no such situation
in the tests). You may assume there will be no empty
strings in the list."""


def shortest(words: list[str]) -> str:
    shortest: str = words[0]
    for w in words:
